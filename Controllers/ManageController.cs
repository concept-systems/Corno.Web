...
namespace Corno.Concept.Portal.Controllers;
...
public class ManageController : Controller
{
    ...
    {   
        return await Task.FromResult(View(new ChangePasswordViewModel())).ConfigureAwait(false);
    }
    ...
    public async Task<ActionResult> LinkLogin(string provider)
    {
        ...
        return await Task.FromResult(new BaseAccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "Manage"), User.Identity.GetUserId())).ConfigureAwait(false);
    }
