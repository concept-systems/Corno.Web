...
{
    public class StandardBomController_old : MasterController <Item>
    {
        #region -- Constructors --
        public StandardBomController_old(IBaseItemService itemService,
            IWebProgressService progressService) 
            : base(itemService, progressService)
        {
