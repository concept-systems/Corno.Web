...
public class ItemDto : MasterDto
{
    #region -- Constructors --

    public ItemDto()
    {
        ItemProcessDtos = new List<ItemProcessDto>();
        ItemMachineDtos = new List<ItemMachineDto>();
        ItemPacketDtos = new List<ItemPacketDto>();
    }
    #endregion
    ...
    public List<ItemProcessDto> ItemProcessDtos { get; set; }
    public List<ItemMachineDto> ItemMachineDtos { get; set; }
    public List<ItemPacketDto> ItemPacketDtos { get; set; }
    #endregion
}